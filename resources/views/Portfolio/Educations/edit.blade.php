    ...
    <main class="max-w-4xl mx-auto px-6 py-12">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-500 mt-2">
                Update the information for this educational background.
            </p>
        ...
        <div class="border border-gray-200 rounded-xl p-8">
            ...
            <form action="{{ route('portfolio.educations.update', $education->id) }}"
                  method="POST"
                  class="space-y-6">
                    ...
                    >
                        ...
                        @foreach ($users as $user)
                            <option value="{{ $user->id }}"
                                {{ old('user_id', $education->user_id) == $user->id ? 'selected' : '' }}>
                                {{ $user->name }}
                            </option>
                        @endforeach
                    </select>
        ...
        <p class="text-sm text-gray-400 mt-6">
            Make sure the education information is accurate before updating.
        </p>
